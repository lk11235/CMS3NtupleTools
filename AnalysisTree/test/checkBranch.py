...
f = ROOT.TFile("/eos/cms/store/group/phys_higgs/cmshzz4l/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/ggH200/ZZ4lAnalysis.root")
t = f.Get("ZZTree/candTree")

blist = t.GetListOfLeaves()

for b in blist:
    print(b.GetName())
    if "sample" in b.GetName():
        break
...
#filename = "/afs/cern.ch/work/l/lkang/CMS3/CMSSW_10_2_22_/src/CMS3/AnalysisTree/test/output/ReweightedGenTrees/8/2017/GGHToZZTo4L_Nominal.root"
...
hp = ROOT.TH1F("pass","",185,150,2000)
# hf = ROOT.TH1F("fail","",4000,0,2000)

hpo = ROOT.TH1F("passo","",185,150,2000)
hfo = ROOT.TH1F("failo","",185,150,2000)

hp1 = ROOT.TH1F("pass1","",185,150,2000)
hf1 = ROOT.TH1F("fail1","",185,150,2000)
hp2 = ROOT.TH1F("pass2","",185,150,2000)
hf2 = ROOT.TH1F("fail2","",185,150,2000)
hp3 = ROOT.TH1F("pass3","",185,150,2000)
hf3 = ROOT.TH1F("fail3","",185,150,2000)
...
tp.Draw("GenHMass>>pass","77.4*event_wgt*KFactor_QCD_ggZZ_Nominal*p_Gen_CPStoBWPropRewgt*p_Gen_GG_SIG_kappaTopBot_1_ghz1_1_MCFM","")

tpo.Draw("GenHMass>>passo","77.4*1000*xsec*KFactor_QCD_ggZZ_Nominal*overallEventWeight*L1prefiringWeight/"+str(f1.Get("ZZTree/Counters").GetBinContent(40)),"")
tfo.Draw("GenHMass>>failo","77.4*1000*xsec*KFactor_QCD_ggZZ_Nominal/"+str(f3.Get("ZZTree/Counters").GetBinContent(40)),"")

tp1.Draw("ZZMass>>pass1","77.4*1000*xsec*KFactor_QCD_ggZZ_Nominal*overallEventWeight*L1prefiringWeight/"+str(f1.Get("ZZTree/Counters").GetBinContent(40)),"")
tf1.Draw("GenHMass>>fail1","77.4*1000*xsec*KFactor_QCD_ggZZ_Nominal/"+str(f3.Get("ZZTree/Counters").GetBinContent(40)),"")
tp2.Draw("ZZMass>>pass2","77.4*1000*xsec*KFactor_QCD_ggZZ_Nominal*overallEventWeight*L1prefiringWeight/"+str(f2.Get("ZZTree/Counters").GetBinContent(40)),"")
tf2.Draw("GenHMass>>fail2","77.4*1000*xsec*KFactor_QCD_ggZZ_Nominal/"+str(f3.Get("ZZTree/Counters").GetBinContent(40)),"")
tp3.Draw("ZZMass>>pass3","77.4*1000*xsec*KFactor_QCD_ggZZ_Nominal*overallEventWeight*L1prefiringWeight/"+str(f3.Get("ZZTree/Counters").GetBinContent(40)),"")
...
hpt = ROOT.TH1F("tot","",185,150,2000)
